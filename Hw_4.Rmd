...
Test Statistic: The number of health code violations reported from Gourmet Bites (50).
(Graph shown above)
P-value: 2e-4
...
calculate_chi_squared(brown_text, brown_table)
